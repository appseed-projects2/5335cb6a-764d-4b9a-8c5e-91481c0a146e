...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-13 14:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5335cb6a-764d-4b9a-8c5e-91481c0a146e.git
$ cd 5335cb6a-764d-4b9a-8c5e-91481c0a146e
```
